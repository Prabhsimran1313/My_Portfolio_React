...
import { techStack, educationData } from "../constants";
import { ThemeContext } from "../themeProvider";
import { motion } from "framer-motion";
import educationIllustration from "../assets/education.png";
  ...
  return (
    <div id="about" className={darkMode === true ? "bg-white" : "bg-gray-900"}>
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 md:mt-0 pt-24 pb-12">
        <h2 className={darkMode ? "text-5xl font-bold px-4 md:px-0 text-center" : "text-5xl font-bold px-4 md:px-0 text-center text-white"}>
          About Me
        </h2>
        <div>
          <motion.div>
            <h4 className="mt-12 text-3xl font-semibold text-blue-500">A bit about me</h4>
            <p className={darkMode ? "mt-4 text-xl text-justify text-gray-500" : "mt-4 text-xl text-justify text-white"}>
        ...
        >
          <div className="md:w-1/2">
            <h4 className="mt-12 text-3xl font-semibold text-blue-500">Education</h4>
            {educationData.map((edu, index) => (
              <div key={index} className="mt-8 p-4 border-l-4 border-blue-500">
                <h5 className={darkMode ? "text-gray-800 font-bold" : "text-white font-bold"}>
                  {edu.degree}
                </h5>
          ...
          <motion.div>
            <h4 className="mt-12 text-3xl font-semibold text-blue-500">Technologies and Tools</h4>
            <p className={darkMode ? "mt-4 text-xl text-justify text-gray-500" : "mt-4 text-xl text-justify text-white"}>
